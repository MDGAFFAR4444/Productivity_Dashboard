...
function weatherFunctionality() {
    var apiKey = 'f60e6a103774409fb71164812262907'
    var city = 'Hyderabad'
...
// Search image started

function searchImageEngine(){
    const searchForm = document.getElementById("search-form");
const searchBox = document.getElementById("search-box");
const searchResult = document.getElementById("search-result");
const searchMoreBtn = document.getElementById("show-more-btn");

const accessKey = "LxmtCnf1WmkLvVsAuBxAWb0YMnOo7TxHjziybOPf2W0"
